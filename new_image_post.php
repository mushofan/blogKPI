...
//Proses post baru
if (isset($_POST['submit']) && (isset($_SESSION['csrf_salt'])) && (isset($_POST['csrf_salt'])))
{
    ...
    if ($_POST['csrf_salt'] === $_SESSION['csrf_salt']) {
        ...
        if (!$image){
            header("Location: new_image_post.php");
            die();
        }
        $filename = base64_encode(openssl_random_pseudo_bytes(18));
        $filename = str_replace('+', 'PL', $filename);
        $filename = str_replace('/', 'PL', $filename);
        $filename = 'images/img_'.$filename.'_'.uniqid("", true).'.jpg';
            ...
            <div class="art-body-inner">
                ...
                <div id="contact-area">
                    <form method="post" action="#" enctype="multipart/form-data">
                        ...
                        <p>Ukuran maksimal gambar 2 megabyte. Format gambar yang didukung adalah JPEG.</p>
